...
@section('content')
<div class="wrapper bgded overlay" style="background-image:url('images/demo/backgrounds/bg02.jpg');">
  <div id="pageintro" class="hoc clear"> 
    <article>
      <p>Let's see where this starts </p>
      <h3 class="heading">This is a simple heading</h3>
...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <ul class="nospace group overview">
      <li class="one_third">
        <figure><a href="#"><img src="{{asset('/images/demo/348x261.png')}}" alt=""></a>
          <figcaption>
...
<div class="wrapper gradient">
  <section id="testimonials" class="hoc container clear"> 
    ...
    <article class="one_half first"><img src="{{asset('/images/demo/100x100.png')}}" alt="">
    ...
    <article class="one_half"><img src="{{asset('/images/demo/100x100.png')}}" alt="">
